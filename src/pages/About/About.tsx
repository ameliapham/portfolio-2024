        ...
        <div className={cx(classes.root, className)}>
            ...
            <div className={classes.content}>
                ...
                <Accordion className={classes.accordion}>
                    ...
                    <AccordionDetails>
                        <Typography variant="body1">
                            HTML - CSS - JavaScript - React - TypeScript - Tailwind CSS - MUI - Framer
                            Motion
                        </Typography>
                    </AccordionDetails>
                </Accordion>
                ...
                <Accordion className={classes.accordion}>
                    ...
                    <AccordionDetails>
                        <Typography variant="body1">
                            Brand Systems - Design Systems - Visual Identities - Interaction Design -
                            Visual Design - Motion Design - Prototyping - User Testing
                        </Typography>
                    </AccordionDetails>
                </Accordion>
