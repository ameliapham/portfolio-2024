...
export function Page3(props: Props) {
    ...
    return (
        <div className={cx(classes.root, className)}>
            ...
            <img src={badgeurColor1} alt="Badgeur color 1" className={cx(classes.image, classes.color1)} />
            <img src={badgeurColor2} alt="Badgeur color 2" className={cx(classes.image, classes.color2)} />
            <img src={badgeurColor3} alt="Badgeur color 3" className={cx(classes.image, classes.color3)} />
        </div>
    );
}
